<template>
  <div id="pokedex">
    ...
    <div>
      ...
      <div id="left-cap"></div>
      <div id="left-cap-border"></div>
      <div id="left-cap-shadow"></div>
      <div id="right-cap"></div>
      <div id="right-cap-shadow"></div>
      <div id="outer-line"></div>
      <div id="border-spacing"></div>
      <div id="inner-border"></div>
      <div id="top-left-corner" class="corner"></div>
      <div id="middle-corner" class="corner"></div>
      <div id="bottom-right-corner" class="corner"></div>
      <div id="bottom-left-corner" class="corner"></div>
      <div id="right-panel-shadow"></div>
